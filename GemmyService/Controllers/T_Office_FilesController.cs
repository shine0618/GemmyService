...
namespace GemmyService.Controllers
{
    public class T_Office_FilesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,partType,Mode,FileName,Nature,Information,Path,Size,Modifydate,Outdate,Person,Type,Permission,Products,Lock,Language,verificationCode,deleteSign,UpdateTime,CreateTime,deletePerson,CreatePerson,UpdatePerson,Remark")] T_Office_Files t_Office_Files)
        {
            if (ModelState.IsValid)
            {
                t_Office_Files.Createdate = DateTime.Now;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,partType,Mode,FileName,Nature,Information,Path,Size,Createdate,Modifydate,Outdate,Person,Type,Permission,Products,Lock,Language,verificationCode,deleteSign,UpdateTime,CreateTime,deletePerson,CreatePerson,UpdatePerson,Remark")] T_Office_Files t_Office_Files)
        {
            if (ModelState.IsValid)
            {
